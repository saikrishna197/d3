...
var linkedbyindex = {};
        ...
        newGs.classed(consts.circleGClass, true)
            ...
            .on("mouseover", function (d) {
                ...
                console.log(d)
paths.style("stroke", function(o) {
    return o.source === d || o.target === d ? '#ffff66' : '#202020';
    });
    var nodeneighbours = thisGraph.edges.filter(function(c){
            return c.source === d || c.target === d ;})
            .map(function(c){
                return c.source === d ? c.target : c.source ;
                });
            svg.selectAll('circle').style('stroke','#202020');
            svg.selectAll('circle').filter(function(node){
            return nodeneighbours.indexOf(node) > -1;
            }).style('stroke','orange');
